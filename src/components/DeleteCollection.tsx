...
import { collection, doc, getDocs, writeBatch, orderBy, query } from 'firebase/firestore';
...
import { Trash2 } from "lucide-react";
  ...
  const DeleteCollection = ({ collectionName}: DeleteCollectionProps) => {
        ...
        <Dialog>
          ...
          <DialogContent className="bg-red-500">
            <DialogHeader>
              ...
              <DialogDescription>
                You are about to delete the data collection <span className="font-bold">{collectionName}</span>! 
              </DialogDescription>
