...
export function ProgramToolbar<TData>({ table }: ProgramToolbarProps<TData>) {
  const categoryOptions = [
    { value: 'Fest', label: 'Fest', color: '#FF0000' },
    { value: 'Sport', label: 'Sport', color: '#00FF00' },
    { value: 'Aktivitet', label: 'Aktivitet', color: '#0000FF' },
    { value: 'Universitetet', label: 'Universitetet', color: '#FFFF00' },
  ];
