  ...
  async function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    try {
      ...
      if (newImageUploaded && fileUrl) {
        ...
        const newImageRef = ref(storage, `Images/${uniqueId}`);
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="time" className="w-50 px-2" {...field} value={field.value} onChange={field.onChange} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={currentData.category}>
                        <FormControl>
                          <SelectTrigger>
